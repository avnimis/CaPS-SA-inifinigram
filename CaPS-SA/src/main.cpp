...
int main(int argc, char* argv[])
{
    ...
    // DNA remapping removed: accept raw bytes directly so tokenized.bin
    // can be passed without any pre-encoding step.

    std::ofstream output(op_path, std::ios::binary);
